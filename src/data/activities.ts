const activities = [
  ...
  //   alt: "personne qui pratique la spéléologie",
  //   title: "Via corda",
  //   text: "Évadez-vous en randonnée verticale alliant tyrolienne, mains courantes et descentes en rappel dans la Haute Vallée de l’Aude.",
  //   links: [
  //     { href: "/", label: "Réserver", style: "secondary" },
  //     { href: "/activites/via-corda", label: "En savoir plus", style: "primary" }
  //   ]
  // }
