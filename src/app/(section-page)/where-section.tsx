...
export default function WhereSection( { className }: { className?: string } ) {
    ...
    return (
        <section className={`flex flex-col gap-12  w-full   max-w-7xl mx-auto   ${className}`}>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-6 ">
                <div className="flex flex-col gap-4 lg:flex-1/3">
                    <h3 className="text-4xl text-center lg:text-start ">Aude , Tarn , Hérault, Pyrénées-Orientales</h3>
