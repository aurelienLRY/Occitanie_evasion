    ...
    return (
        <CustomSection className={`flex flex-col gap-11 items-center justify-center w-full      ${className}`} >
            <div className="flex flex-col justify-center w-full max-w-7xl mx-auto px-4 lg:px-0 relative ">
                <h2 className="!text-6xl lg:!text-8xl text-center lg:text-start  ">L&apos;évasion commence ici <span className="text-secondary">!</span></h2>
                <h3 className="!text-4xl lg:!text-6xl text-center lg:text-start   ">Tu cherches une activité <span className="text-secondary">?</span></h3>
