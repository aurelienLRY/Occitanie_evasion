...
const ServicesSection = ( { className }: { className?: string } ) => {
    return (
        <CustomSection className={`flex flex-col gap-11 items-center justify-center w-full      ${className}`} >
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex flex-col justify-center w-full max-w-7xl mx-auto px-4 lg:px-0 relative ">
