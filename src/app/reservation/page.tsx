...
const Reservation = () => {
    ...
    return (
        <div className="min-h-fit py-12 mt-20">
            <div className="container mx-auto">
                <div className="mb-12">
                    ...
                    <p className="text-gray-600 text-center">
                        {activeSessions && activeSessions.length > 0 ? "Tu as le choix , entre rejoindre une des session déjà programmées ou créer la tienne via le formulaire ci-dessous." : ""}
                    </p>
                </div>
