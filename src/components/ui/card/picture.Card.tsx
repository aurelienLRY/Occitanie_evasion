...
const PictureCard = ({url, alt , backgroundColor = "white"}: {url: string, alt: string, backgroundColor?: string}) => {
    return (
        <div className={cn("relative min-h-[300px] lg:min-h-[400px] lg:h-full max-h-[400px] aspect-square overflow-hidden ", backgroundColor ? `text-${backgroundColor}` : "text-white")}  >
